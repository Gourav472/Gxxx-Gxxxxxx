            ...
            <footer className=' bg-black'>
                <div className=' container'>
                    <div className="row footer-py">
                        <div className="col-12 col-md-4 col-lg-3 d-flex" data-aos="fade-up">
                        ...
                        <div className="col-6 col-md-4 col-lg-3 d-flex justify-content-md-center mt-5 mt-md-0 " data-aos="fade-up">
                            <div className=' d-flex align-items-center align-items-sm-start gap-footer-links'>
                                ...
                                <ul className=' m-0 p-0 d-flex flex-column gap-17'>
                                    <li className=' ff-inter fw-700 text-16 lh-25 white'>QUICK LINKS</li>
                                    <li><a href="https://x.com/?lang=en" target='_blank' className=' ff-inter fw-400 text-16 lh-25 white pt-13 link_hover'>Twitter</a></li>
                        ...
                        <div className="col-6 col-md-4 col-lg-6 align-items-end justify-content-end justify-content-md-start mb-3 mb-md-0 mt-5 mt-md-0 d-flex flex-column align-items-lg-end" data-aos="fade-up">
